  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2927760872U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(715814416U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4265783805U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2660182665U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "Y7suIlZfCE9hACSEVTNfgD") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "t36LqlGcwUhlLpZD7BMNpD") == 0) {
